...
void mle_MacKenzie_NLL_Uneven_Minimization_DRIVER ( int No_of_SPECIES,
	                                                  char ** Species_Tag,
																										double *** Presence,
																										int * No_of_SITES,
																										double ** Time_Vector,
																											 ...
																											 double * R_Results )
{
  ...
  */
  ...
  mle_MacKenzie_NLL_Uneven_Minimization_DRIVER (No_of_SPECIES, Species_Tag,
...
void mle_MacKenzie_NLL_Uneven_Minimization_DRIVER (int No_of_SPECIES,
  ...
  */
  ...
  for( i=0; i<No_of_SPECIES; i++ ) {
    ...
    SP_Matrix_Data_Alloc( No_of_SITES[i], No_of_COLUMNS, No_of_COLUMNS, //No_of_TIME_OBS_MAX, No_of_TIME_OBS_MAX,
			                    Data[i]);
    SP_Matrix_Data_Setup( No_of_SITES[i], No_of_COLUMNS, Total_No_of_Transects[i],
			                    Data[i], Presence[i], Time_Vector[i], Sp_Time[i], Sp_No_of_Times[i],
